...
qx.$$loader = {
  parts : {"boot":[0]},
  packages : {"0":{"uris":["__out__:wialon.bc3dfb51bc4d.js"]}},
  urisBefore : [],
  cssBefore : [],
  boot : "boot",
  closureParts : {},
...
(function(){
  ...
  var a = 'action',b = "unit/update_sensor",c = "resource/update_poi",d = "unit_commands",f = "unitSensors",g = "adminField",h = "itemProfileFields",j = "resource/update_drivers_group",l = "unsl",m = "u",n = "https://geocode-maps.wialon.com",o = "zonesGroup",p = "item/delete_item",q = "singleton",r = "resourcePois",s = 'zl',t = "ftp",u = 'function',v = "resourceZoneGroups",w = "item/update_admin_field",x = "&svc=file/get&params=",y = "script",z = "unit/update_task",A = "core/check_items_billing",B = "resource/get_job_data",C = "qx.event.type.Event",D = "//",E = "item/update_profile_field",F = "resource/get_poi_data",G = "ujb",H = "token/login",I = "token/update",J = "jobs",K = "file/list",L = "__db",M = "__df",N = "unitFuelSettings",O = "local",P = "route/get_round_data",Q = "flds",R = "core/get_hw_types",S = 'driver',T = "userNotification",U = "si",V = "order_routes",W = "lang",X = "core/search_item",Y = "profileField",fU = "=",fP = 'tags',fV = "core/create_resource",fR = "unsubscription",fS = "core/create_user",fE = "?sid=",fT = "number",ga = "firmware",gb = "customField",gc = "core/create_unit",gd = "https://search-maps.wialon.com",fW = "; ",fX = "usnf",fQ = "notifications",fY = "qx.event.type.Data",gh = "token/list",gK = "healthCheck",gi = "routeSchedules",gj = "core/login",ge = "route/update_round",gf = "string",hL = "account/get_business_spheres",gg = "resourceUnsubscription",gk = "[\\?&]callback=([^&#]*)",gl = "core/create_auth_hash",gm = "poi",gr = "ud",gs = "core/update_data_flags",gt = "serviceInterval",gn = "core/create_retranslator",go = "resourceReports",gp = "core/reset_password_perform",gq = "unitReportSettings",gy = "sensor",gz = "tasksUpdated",gA = 'trailer',gB = "__de",gu = "https://render-maps.wialon.com",gv = "/avl_evts",gw = "core/create_route",gx = "round",gF = "rr",gG = "core/create_unit_group",hU = "unf",gH = "item/update_ftp_property",gC = "aflds",gD = "mapps",hS = 'resource/update_zone',gE = "serverUpdated",gI = "core/get_account_data",gJ = "d",gV = 'resource/update_trailer',gU = "fileUploaded",gT = "avl_evts",ha = '.all',gY = "resourceDrivers",gX = "commandDefinition",gW = 'drvrs',gO = "unitServiceIntervals",gN = "resource/update_zones_group",gM = "function",gL = "tagsgr",gS = "rep",gR = "report/update_report",gQ = "resource/update_job",gP = "rs",hh = "report",hg = "wialon.js",hf = "en",he = "itemCreated",hl = "unitEventRegistrar",hk = "orders",hj = 'undefined',hi = 'tag',hd = "user/update_user_notification",hc = "unitHealthCheck",hb = "avl_evts:request",hw = 'resource/get_zone_data',hv = "unitCommandDefinitions",hu = 'trigger',hA = "user/send_sms",hz = "core/get_hw_cmds",hy = "file/read",hx = "route/update_schedule",hp = 'trlrs',ho = "account/get_account_data",hn = "/wialon/ajax.html",hm = "resourceDriverGroups",ht = "hch",hs = "m",hr = "resource/update_trailers_group",hq = "report/get_report_tables",hG = "resourceAccounts",hF = "resourceTags",hE = "mobileApps",hD = "account/list_change_accounts",hK = "notification",hJ = "resource/update_unsubscription",hI = "unit/update_command_definition",hH = "itemIcon",hC = "order/route_update",hB = "schedule",eJ = 'zone',eI = "col",hV = '',eG = "1.51",eH = "file/library",eF = "statsFinished",hT = 'resource/update_tag',eD = "itemFtpProps",eE = "core/search_items",eC = "core/duplicate",hQ = "https://routing-maps.wialon.com",eA = "trlrsgr",eB = "FtpProp",ez = "order/update",eS = "trailersGroup",eT = "mobileApp",eQ = "object",eR = "sensu",eO = "resource/update_notification",eP = "unitDriveRankSettings",eN = "orderRoute",ey = "wialon.core.Session",eL = "featuresUpdated",eM = "item/update_custom_field",eK = "unit/update_service_interval",fh = "invalidSession",ff = "drvrsgr",fg = "resourceJobs",fd = "core/use_auth_hash",fe = "resourceTrailers",fc = "routeRounds",hO = "resourceTrailerGroups",fa = "core/logout",fb = "driversGroup",eY = "core/set_session_property",hR = "resourceNotifications",eW = "resource/update_tags_group",eX = "order",eU = "job",eV = "resourceOrders",fp = "core/check_accessors",fq = "core/reset_password_request",fn = "resource/get_notification_data",fo = '.',fl = "itemAdminFields",fm = "report/get_report_data",fk = "unitMessagesFilter",hN = "cml",fi = "/",fj = "&svc=core/export_file&params=",fD = "tagsGroup",hM = "unitTripDetector",fF = "",fA = "__cX",fz = "resourceZones",fC = "userNotifications",fB = 'resource/update_driver',fw = "unit_sensors",fv = "sens",fy = "Can't parse avl_evts json, possible wrong chars in responce. Data is ignored.",fx = "itemDeleted",fs = "unitsUpdated",fr = "itemCustomFields",fu = "unitEvents",ft = "reporttemplates",fM = 'u',fL = 'notifications',fO = "pflds",fN = "user/update_mobile_app",fI = "messages/get_task_messages",fH = "undefined",fK = "unit/update_health_check",fJ = '/',fG = "zg";
  qx.Class.define(ey, {
    extend : qx.core.Object,
    type : q,
    construct : function(){
    ...
    members : {
      ...
      __dJ : null,
      __dK : null,
      initSession : function(hY, hX, hW, ic, ia, ie){
        ...
        this.__dg = hY;
        this.__dw = hY;
        if(typeof hX != fH)this.__di = hX;
        if(typeof hW != fH && !isNaN(parseInt(hW))){

          var ib = parseInt(hW);
          if(ib & 0x800)this.__dh = true;
        };
        if(typeof ic != fH)this.__dk = ic;
        ...
        if(ie){
          ...
          if(ie.apiPath)this.__dB = ie.apiPath;
          if(ie.gisUrl)this.__dw = ie.gisUrl;
          this.__dC = !!ie.ignoreBaseUrl;
          this.__dD = !!ie.whiteLabel;
          this.__dF = ie.logger;
          this.__dG = ie.loginSiteName;
          this.__dE = ie.requestWebSites;
        };
        return true;
      },
      ...
      login : function(ik, ii, ij, ih){
        ...
        }, qx.lang.Function.bind(this.__dS, this, ih));
      },
      loginAuthHash : function(iq, ip, im){

        var il = fF;
        if(ip && typeof ip == gM)im = ip; else if(ip && typeof ip == gf)il = ip;;
        ...
        if(this.__dG)io.siteName = this.__dG;
        if(this.__dE)io.webSite = 1;
        return wialon.core.Remote.getInstance().remoteCall(fd, io, qx.lang.Function.bind(this.__dS, this, im));
      },
      loginToken : function(it, iv, is){

        var ir = fF;
        if(iv && typeof iv == gM)is = iv; else if(iv && typeof iv == gf)ir = iv;;
        ...
        if(this.__dG)iu.siteName = this.__dG;
        if(this.__dE)iu.webSite = 1;
        return wialon.core.Remote.getInstance().remoteCall(H, iu, qx.lang.Function.bind(this.__dS, this, is));
      },
      duplicate : function(iC, iz, iw, iB, ix){
        ...
        var iy = {
          operateAs : iz,
          continueCurrentSession : iw,
          checkService : this.__dk,
          restore : iA,
          appName : this.__di
        };
        if(this.__dG)iy.siteName = this.__dG;
        if(this.__dE)iy.webSite = 1;
        return wialon.core.Remote.getInstance().remoteCall(eC, iy, qx.lang.Function.bind(this.__dS, this, iB));
      },
      logout : function(iD){
        ...
        return wialon.core.Remote.getInstance().remoteCall(fa, null, qx.lang.Function.bind(function(iE, iF){
      ...
      updateSessionProperty : function(iI, iH){

        return wialon.core.Remote.getInstance().remoteCall(eY, {
          prop_name : iI.propName,
          prop_value : iI.propValue
        }, wialon.util.Helper.wrapCallback(iH));
      },
      updateToken : function(iJ, iK, iL){
        ...
        return wialon.core.Remote.getInstance().remoteCall(I, {
          ...
          p : iK.p,
          items : iK.items,
          deleteAll : iK.deleteAll,
          userId : iK.userId
        }, iL);
      },
      listTokens : function(iN, iM){
      ...
      updateDataFlags : function(iP, iO){

        iO = wialon.util.Helper.wrapCallback(iO);
        if(!this.__cX || typeof iP != eQ){
        ...
        return wialon.core.Remote.getInstance().remoteCall(gs, {
          spec : iP
        }, qx.lang.Function.bind(this.__dT, this, iO));
      },
      searchItems : function(iU, iT, iQ, iS, iR, iV, iW){

        iV = wialon.util.Helper.wrapCallback(iV);
        if(!this.__cX || typeof iU != eQ){

          iV(2, null);
          return;
        };
        return wialon.core.Remote.getInstance().remoteCall(eE, {
          spec : iU,
          force : iT ? 1 : 0,
          flags : iQ,
          from : iS,
          to : iR
        }, qx.lang.Function.bind(this.__dU, this, iV), iW);
      },
      searchItem : function(ja, iX, iY){

        iY = wialon.util.Helper.wrapCallback(iY);
        if(!this.__cX){
        ...
        return wialon.core.Remote.getInstance().remoteCall(X, {
          id : ja,
          flags : iX
        }, qx.lang.Function.bind(this.__dV, this, iY));
      },
      loadLibrary : function(jd){

        var jb = wialon.core.Session.getInstance();
        if(typeof this._libraries[jd] != fH)return true;
        if(jd == fC)wialon.item.PluginsManager.bindPropItem(wialon.item.User, fX, T, hd); else if(jd == fr)wialon.item.PluginsManager.bindPropItem(wialon.item.Item, Q, gb, eM); else if(jd == eD)wialon.item.PluginsManager.bindPropItem(wialon.item.Item, t, eB, gH); else if(jd == fl)wialon.item.PluginsManager.bindPropItem(wialon.item.Item, gC, g, w); else if(jd == h)wialon.item.PluginsManager.bindPropItem(wialon.item.Item, fO, Y, E); else if(jd == hH){

          qx.Class.include(wialon.item.Unit, wialon.item.MIcon);
          qx.Class.include(wialon.item.UnitGroup, wialon.item.MIcon);
        } else if(jd == hv)wialon.item.PluginsManager.bindPropItem(wialon.item.Unit, hN, gX, hI); else if(jd == f){

          wialon.item.PluginsManager.bindPropItem(wialon.item.Unit, fv, gy, b);
          qx.Class.include(wialon.item.Unit, wialon.item.MUnitSensor);
        } else if(jd == gO)wialon.item.PluginsManager.bindPropItem(wialon.item.Unit, U, gt, eK); else if(jd == hc)wialon.item.PluginsManager.bindPropItem(wialon.item.Unit, ht, gK, fK); else if(jd == hM)qx.Class.include(wialon.item.Unit, wialon.item.MUnitTripDetector); else if(jd == fk)qx.Class.include(wialon.item.Unit, wialon.item.MUnitMessagesFilter); else if(jd == hl)qx.Class.include(wialon.item.Unit, wialon.item.MUnitEventRegistrar); else if(jd == gq)qx.Class.include(wialon.item.Unit, wialon.item.MUnitReportSettings); else if(jd == eP)qx.Class.include(wialon.item.Unit, wialon.item.MUnitDriveRankSettings); else if(jd == N)qx.Class.include(wialon.item.Unit, wialon.item.MUnitFuelSettings); else if(jd == gg)wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, l, fR, hJ); else if(jd == hR)wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, hU, hK, eO, fn); else if(jd == fg)wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, G, eU, gQ, B); else if(jd == fz){
          ...
          wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, {
            ...
            ajaxPath : hS,
            extAjaxPath : hw,
            preProcessUpdateCallObj : function(jg){

              var jf = jb.getCoordinatesTransformer();
              if(!jf)return jg;
              return jc(jf.reverse.bind(jf), jg);
            },
            preProcessPropObj : function(ji){

              var jh = jb.getCoordinatesTransformer();
              if(!jh)return ji;
              return jc(jh.direct.bind(jh), ji);
            }
          });
        } else if(jd == v){

          qx.Class.include(wialon.item.Resource, wialon.item.MZone);
          wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, fG, o, gN);
        } else if(jd == r){

          qx.Class.include(wialon.item.Resource, wialon.item.MPoi);
          wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, gm, gm, c, F);
        } else if(jd == gY){
          ...
          wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, {
            ...
            itemName : S,
            ajaxPath : fB,
            preProcessPropObj : je
          });
        } else if(jd == hm){

          qx.Class.include(wialon.item.Resource, wialon.item.MDriver);
          wialon.item.MDriver.registerDriverProperties();
          wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, ff, fb, j);
        } else if(jd == fe){
          ...
          qx.Class.include(wialon.item.Resource, wialon.item.MDriver);
          wialon.item.MDriver.registerDriverProperties();
          wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, eA, eS, hr);
        } else if(jd == hG){
          ...
          wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, gS, hh, gR, fm);
        } else if(jd == fc)wialon.item.PluginsManager.bindPropItem(wialon.item.Route, gF, gx, ge, P); else if(jd == gi)wialon.item.PluginsManager.bindPropItem(wialon.item.Route, gP, hB, hx); else if(jd == fu)qx.Class.include(wialon.item.Unit, wialon.item.MUnitEvents); else if(jd == hE)wialon.item.PluginsManager.bindPropItem(wialon.item.User, gD, eT, fN); else if(jd == eV){

          qx.Class.include(wialon.item.Resource, wialon.item.MOrder);
          wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, hk, eX, ez);
          qx.Class.include(wialon.item.Resource, wialon.item.MOrderRoute);
          wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, V, eN, hC);
        } else if(jd == hF){

          qx.Class.include(wialon.item.Resource, wialon.item.MTag);
          wialon.item.MTag.registerTagProperties();
          wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, gL, fD, eW);
          wialon.item.PluginsManager.bindPropItem(wialon.item.Resource, {
            propName : fP,
            itemName : hi,
            ajaxPath : hT,
        ...
        function jc(js, jj){
          ...
          if(jr){
            ...
            var jo = jt.x !== jr.cen_y || jt.y !== jr.cen_y;
            if(jo){

              var jl = (jr.min_x - jr.cen_x) * jp;
              var jn = (jr.max_x - jr.cen_x) * jp;
              var jk = (jr.min_y - jr.cen_y) * jp;
              var ju = (jr.max_y - jr.cen_y) * jp;
              jm = true;
              jr = {
                cen_x : jt.x,
                cen_y : jt.y,
        ...
        function je(jx){
          ...
          var jw = jb.getCoordinatesTransformer();
          if(!jw)return jx;
          if(!jx || !jx.pos)return jx;
          var jy = jw.direct(jx.pos);
          if(jy !== jx.pos){
      ...
      getHwTypes : function(jA, jz){

        var jB = {
        };
        if(jA && typeof jA == gM)jz = jA; else if(jA && typeof jA == eQ)jB = jA;;
        if(!this.__cX){
        ...
        return wialon.core.Remote.getInstance().remoteCall(R, {
          filterType : jB.filterType,
          filterValue : jB.filterValue,
          includeType : jB.includeType
        }, wialon.util.Helper.wrapCallback(jz));
      },
      getHwCommands : function(jC, jD, jE){
        ...
        return wialon.core.Remote.getInstance().remoteCall(hz, {
          deviceTypeId : jC,
          unitId : jD
        }, jE);
      },
      getHwCommandTemplates : function(jH, jF){
        ...
        if(jH && typeof jH == eQ){
          ...
          jG.deviceTypeId = arguments[0];
          jG.unitId = arguments[1];
          jG.lang = hf;
          jF = wialon.util.Helper.wrapCallback(arguments[2]);
        };
        if(!this.__cX){
        ...
        return wialon.core.Remote.getInstance().remoteCall(hz, {
          deviceTypeId : jG.deviceTypeId,
          unitId : jG.unitId,
          template : 1,
          lang : jG.lang
        }, jF);
      },
      createUnit : function(jL, name, jJ, jI, jK){

        jK = wialon.util.Helper.wrapCallback(jK);
        if(!this.__cX){
        ...
        return wialon.core.Remote.getInstance().remoteCall(gc, {
          ...
          hwTypeId : jJ,
          dataFlags : jI
        }, qx.lang.Function.bind(this.__dV, this, jK));
      },
      createUser : function(jN, name, jQ, jM, jP, jO){

        jO = jO || 0;
        jP = wialon.util.Helper.wrapCallback(jP);
        if(!this.__cX){
        ...
        return wialon.core.Remote.getInstance().remoteCall(fS, {
          ...
          dataFlags : jM,
          logInvalid : jO
        }, qx.lang.Function.bind(this.__dV, this, jP));
      },
      createUnitGroup : function(jT, name, jR, jS){

        jS = wialon.util.Helper.wrapCallback(jS);
        if(!this.__cX){

          jS(2);
          return;
        };
        return wialon.core.Remote.getInstance().remoteCall(gG, {
          creatorId : jT.getId(),
          name : name,
          dataFlags : jR
        }, qx.lang.Function.bind(this.__dV, this, jS));
      },
      createRetranslator : function(jX, name, jW, jU, jV){

        jV = wialon.util.Helper.wrapCallback(jV);
        if(!this.__cX){
        ...
        return wialon.core.Remote.getInstance().remoteCall(gn, {
          ...
          config : jW,
          dataFlags : jU
        }, qx.lang.Function.bind(this.__dV, this, jV));
      },
      createRoute : function(kb, name, jY, ka){

        ka = wialon.util.Helper.wrapCallback(ka);
        if(!this.__cX){

          ka(2);
          return;
        };
        return wialon.core.Remote.getInstance().remoteCall(gw, {
          creatorId : kb.getId(),
          name : name,
          dataFlags : jY
        }, qx.lang.Function.bind(this.__dV, this, ka));
      },
      createResource : function(kf, name, kc, ke, kd){

        kd = wialon.util.Helper.wrapCallback(kd);
        if(!this.__cX){
        ...
        return wialon.core.Remote.getInstance().remoteCall(fV, {
          ...
          skipCreatorCheck : ke,
          dataFlags : kc
        }, qx.lang.Function.bind(this.__dV, this, kd));
      },
      deleteItem : function(kj, kg, kh){
        ...
        kg = wialon.util.Helper.wrapCallback(kg);
        return wialon.core.Remote.getInstance().remoteCall(p, ki, qx.lang.Function.bind(this.__dW, this, kg, kj.getId()));
      },
      updateItem : function(kl, km){
        ...
        if(km.tp === gr){
          ...
          if(km.pos){
            ...
            if(typeof km.pos.t === fH)km.pos.t = km.t;
            if(typeof km.pos.f === fH)km.pos.f = km.f;
            if(typeof km.pos.lc === fH)km.pos.lc = km.lc;
          };
        };
        for(var kk in km){

          switch(kk){case fv:case eR:
          continue;};
          kn.call(this, kk);
        };
        if(Object.prototype.hasOwnProperty.call(km, fv))kn.call(this, fv);
        if(Object.prototype.hasOwnProperty.call(km, eR))kn.call(this, eR);
        function kn(ko){
      ...
      getIconsLibrary : function(kq, ks, kt){

        var kr = 0;
        if(typeof kt != fH)kr = ks; else kt = ks;
        wialon.core.Remote.getInstance().remoteCall(eH, {
          type : kq,
          flags : kr
        }, wialon.util.Helper.wrapCallback(kt));
      },
      getFirmwareLibrary : function(kv, ku){
        ...
        wialon.core.Remote.getInstance().remoteCall(K, {
          ...
          recursive : true,
          fullPath : true
        }, wialon.util.Helper.wrapCallback(ku));
      },
      getLibraryFile : function(kw){
        ...
        return wialon.core.Session.getInstance().getBaseUrl() + this.__dB + fE + wialon.core.Session.getInstance().getId() + x + wialon.util.Json.stringify(kx);
      },
      readLibraryFile : function(ky, kz){

        wialon.core.Remote.getInstance().remoteCall(hy, {
          itemId : 0,
          storageType : 1,
          path : ky
        }, wialon.util.Helper.wrapCallback(kz));
      },
      resetPasswordRequest : function(kH, kG, kD, kF, kC){
        ...
        var kB = document.cookie.split(fW);
        var kA = hf;
        for(var i = 0;i < kB.length;i++){

          var kE = kB[i].split(fU);
          if(kE.length == 2 && kE[0] == W){
      ...
      resetPasswordPerform : function(kK, kJ, kI){

        kI = wialon.util.Helper.wrapCallback(kI);
        if(!this.__cS){

          kI(2);
          return;
        };
        return wialon.core.Remote.getInstance().remoteCall(gp, {
          user : kK,
          code : kJ
        }, kI);
      },
      sendSms : function(kM, kN, kL){

        return wialon.core.Remote.getInstance().remoteCall(hA, {
          phoneNumber : kM,
          smsText : kN
        }, wialon.util.Helper.wrapCallback(kL));
      },
      getAccountData : function(kP, kO){

        return wialon.core.Remote.getInstance().remoteCall(gI, {
          type : kP ? 2 : 1
        }, wialon.util.Helper.wrapCallback(kO));
      },
      getAccountsData : function(kR, kS, kQ){
        ...
        return wialon.core.Remote.getInstance().remoteCall(ho, {
          itemId : kR,
          type : kS
        }, wialon.util.Helper.wrapCallback(kQ));
      },
      checkItemsBilling : function(kT, kU, kV, kW){

        return wialon.core.Remote.getInstance().remoteCall(A, {
          items : kT,
          serviceName : kU,
          accessFlags : kV
        }, wialon.util.Helper.wrapCallback(kW));
      },
      checkAccessors : function(kY, kX){

        return wialon.core.Remote.getInstance().remoteCall(fp, kY, wialon.util.Helper.wrapCallback(kX));
      },
      listChangeAccount : function(lb, la){

        return wialon.core.Remote.getInstance().remoteCall(hD, {
          dataFlags : lb.dataFlags,
          units : lb.units
        }, wialon.util.Helper.wrapCallback(la));
      },
      getBusinessSpheres : function(lc, ld){

        var le = {
        };
        lc && (le.lang = lc);
        return wialon.core.Remote.getInstance().remoteCall(hL, le, wialon.util.Helper.wrapCallback(ld));
      },
      getReportTables : function(lf){

        return wialon.core.Remote.getInstance().remoteCall(hq, {
        }, wialon.util.Helper.wrapCallback(lf));
      },
      setLoginHash : function(lg){

        this.__dj = lg;
      },
      getExportListUrl : function(li){

        var lh = qx.lang.Object.clone(li);
        return wialon.core.Session.getInstance().getBaseUrl() + this.__dB + fE + wialon.core.Session.getInstance().getId() + fj + encodeURIComponent(wialon.util.Json.stringify(lh));
      },
      ...
      getItem : function(lj){
        ...
        var lk = this.__db[parseInt(lj)];
        if(typeof lk != hj)return lk;
        return null;
      },
      getItems : function(ln){

        if(!this.__db || !this.__dc)return null;
        if(typeof ln == fH || ln == fF){

          var lm = new Array;
          for(var ll in this.__db)lm.push(this.__db[ll]);
          return lm;
        } else {

          var lo = this.__dc[ln];
          if(typeof lo != fH)return lo;
        };
        return (new Array);
      },
      registerConstructor : function(lp, lq){

        if(typeof this.__cR[lp] != fH)return;
        this.__cR[lp] = lq;
      },
      registerProperty : function(lr, ls){

        if(typeof this.__cQ[lr] != fH)return;
        this.__cQ[lr] = ls;
      },
      getBaseUrl : function(){
      ...
      setEvtPollInterval : function(lu){
        ...
        if(this.__cU !== lu){
          ...
          if(this.__cV){
            ...
            if(lx >= lv){
              ...
              this.__cV = qx.lang.Function.delay(this.__dL, lw, this);
            };
          };
        };
      },
      getBaseGisUrl : function(ly){

        if(!this.__dh && this.__dw != fF){

          var lz = this.__dw.split(D);
          if(lz.length >= 2){
      ...
      checkFeature : function(lD, lF){

        var lC = this.checkFullFeature(lD);
        if(lF || this.__gi.indexOf(lD) === -1){

          return lC;
        };
        if(lD === fL && !lC){

          var lB = this.checkSubfeatures(lD, hu);
          var lE = this.checkSubfeatures(lD, a);
          if(!lE || !lB){
        ...
        return lC || this.checkSubfeatures(lD);
      },
      checkFullFeature : function(lG){

        if(!this.__dm || typeof this.__dm.svcs == fH || !lG)return 0;
        if(typeof this.__dm.svcs[lG] == fH){

          if(this.__dm.unlim == 1)return 1;
          return 0;
        };
        var lH = this.__dm.svcs[lG];
        if(lH == 1)return 1; else if(lH == 0)return -1;;
        return 0;
      },
      checkSubfeatures : function(lN, lI){

        if(!this.__dm || typeof this.__dm.svcs == fH || !lN)return 0;
        var lK = this.checkFullFeature(lN + ha);
        if(!lK){
        ...
        var lL = this.getSubfeatures(lN, lI);
        var lJ = 0;
        var lM = 0;
        var lO = Object.keys(lL).length;
        for(var name in lL){
      ...
      getSubfeatures : function(lU, lP){
        ...
        var lQ = lU + ha;
        if(!this.checkFullFeature(lQ)){

          return {
          };
        };
        var lV = new RegExp(lU + (lP ? fo + lP : hV) + fo);
        var lS = {
        };
        var lR = this.getFeatures().svcs;
        for(var lT in lR){

          if(lV.test(lT) && lT !== lQ){

            lS[lT] = this.checkFullFeature(lT);
          };
        };
        return lS;
      },
      ...
      updateTaskAsync : function(lY, lX){

        return wialon.core.Remote.getInstance().remoteCall(z, lY, qx.lang.Function.bind(function(mc, mb){

          if(typeof mb.error === fT){

            typeof lX === u && lX(mc, mb);
            return;
          };
          var ma = this.__gn[lY.taskId];
          if(ma){

            ma.p = Object.assign({
            }, ma.p, lY.props);
            typeof lX === u && lX(null, this.__gn);
            this.fireDataEvent(gz, this.__gn);
          };
        }, this));
      },
      getRemoteTasksAsync : function(me, md){

        return wialon.core.Remote.getInstance().remoteCall(fI, me, qx.lang.Function.bind(function(mg, mf){

          if(typeof mf.error === fT){

            typeof md === u && md(mg, mf);
            return;
          };
          if(mf && mf.messages){
            ...
            mf.messages.forEach(qx.lang.Function.bind(function(mh){

              this.__gn[mh.p.task_id] = mh;
            }, this));
          };
          typeof md === u && md(null, this.__gn);
          this.fireDataEvent(gz, this.__gn);
        }, this));
      },
      __dL : function(){
        ...
        this.__cV = null;
        this.__cW = Date.now();
        if(!this.__cT || !this.__cU || typeof wialon === fH)return;
        if(this.__dF && (typeof this.__dF.info === gM)){
        ...
        wialon.core.Remote.getInstance().ajaxRequest(gv, {
          sid : this.__cT
        }, qx.lang.Function.bind(this.__dM, this, this.__cT), 60);
      },
      __dM : function(mk, mi, mj){
        ...
        if(mi != 0){
          ...
          if(mi == 1){
            ...
            if(this.__dO(mk))this.fireEvent(fh);
          } else if(this.__cU){
        ...
        if(this.__dI){
          ...
          for(var i = 0;i < mj.events.length;i++){

            this.emitRawServerEvent(mj.events[i]);
          };
          this.fireEvent(gE);
        };
        if(mj.units_update){

          this.fireDataEvent(fs, mj.units_update, null);
        };
        if(this.__go){
      ...
      emitRawServerEvent : function(ms){
        ...
        try{
          ...
          if(ms.i > 0){
            ...
            mq = this.getItem(ms.i);
            if(mq && typeof mq != fH){

              var mr = ms && ms.d && ms.d.p && ms.d.p.task_id;
              if(mr){

                this.__gp(mr, ms);
              } else if(ms.t == m)this.updateItem(mq, ms.d); else if(ms.t == hs)mq.handleMessage(ms.d); else if(ms.t == gJ)this._onItemDeleted(mq);;;;
            } else {

              if(ms && (typeof ms.i === fT) && (ms.t === fM)){

                var mp = this.__dl[ms.i];
                if(!mp){
            ...
            this.fireDataEvent(gU, ms.d, null);
          } else if(ms.i == -2){

            if(this.__dO(this.getId()))this.fireEvent(fh);
          } else if(ms.i == -3){
            ...
            this.fireDataEvent(eF, ms.d, null);
          } else if(ms.i == -5){

            var mt = ms.d;
            if(typeof mt.r != fH && mt.r.length){

              for(i = 0;i < mt.r.length;i++){

                mq = this.getItem(mt.r[i]);
                if(mq){

                  this._onItemDeleted(mq);
                };
              };
            };
            if(typeof mt.a != fH && mt.a.length){

              var mo = [];
              for(i = 0;i < mt.a.length;i++){
      ...
      checkNewItems : function(my, mv){

        var mz = my.ids,mw = my.updateDataFlagsSpec;
        var mx = wialon.core.Session.getInstance();
        mz = mz.filter(qx.lang.Function.bind(function(mA){

          if(this.__dN[mA])return false;
          if(this.getItem(mA))return false;
          this.__dN[mA] = true;
          return true;
        }, this));
        if(!mw){
        ...
        this.updateDataFlags(mw, qx.lang.Function.bind(function(mC){

          mz.forEach(qx.lang.Function.bind(function(mD){

            delete this.__dN[mD];
          }, this));
          if(mC){

            if(typeof mv === gM)mv(mC);
            return;
          };
          var mB = [];
          mz.forEach(qx.lang.Function.bind(function(mF){

            var mE = this.getItem(mF);
            if(!mE)return;
            mB.push(mE);
          }, this));
          this.fireDataEvent(he, mB, null);
          if(typeof mv === gM)mv(null);
        }, this));
      },
      parseSessionData : function(mH){

        if(!mH || this.__cX)return false;
        this.__cT = mH.eid;
        this.__cU = 2;
        this.__cY = mH.tm;
        this.__dd = mH.au;
        this.__ds = (mH.api && mH.api.indexOf(O) >= 0) ? 1 : 0;
        if(mH.wsdk_version)this.__dp = mH.wsdk_version;
        if(mH.hl)this.__dr = mH.hl;
        this.__da = {
        };
        for(var mG in mH.classes)this.__da[mH.classes[mG]] = mG;
        this.__db = {
        };
        this.__dc = {
        };
        this.__cX = this.__dP(mH.user, wialon.item.User.defaultDataFlags());
        this.__dQ(this.__cX);
        if(mH.token){

          try{

            this.__dq = wialon.util.Json.parse(mH.token);
            if(mH.th)this.__dq.th = mH.th;
        ...
        if(typeof mH.features != fH)this.__dm = mH.features;
        if(mH.gis_render){

          this.__dx = mH.gis_render.replace(/\/+$/, hV);
        };
        if(mH.gis_geocode){

          this.__dz = mH.gis_geocode.replace(/\/+$/, hV);
        };
        if(mH.gis_search){

          this.__dy = mH.gis_search.replace(/\/+$/, hV);
        };
        if(mH.gis_routing){

          this.__dA = mH.gis_routing.replace(/\/+$/, hV);
        };
        if(mH.gis_sid){

          this.__gj = mH.gis_sid.replace(/\/+$/, hV);
        };
        if(mH.video_service_url){

          this.__gk = mH.video_service_url.replace(/\/+$/, hV);
        };
        if(mH.video_service_base_url){

          this.__gl = mH.video_service_base_url.replace(/\/+$/, hV);
        };
        if(typeof mH.base_url != fH && mH.base_url != fF && mH.base_url != this.getBaseUrl()){

          this.__dw = mH.base_url;
          if(!this.__dC){

            this.setBaseUrl(mH.base_url);
          };
        };
        wialon.core.Remote.getInstance().updateGisSenders();
        this.__dt = mH.hw_gw_ip || fF;
        this.__du = mH.hw_gw_dns || fF;
        if(typeof mH.env != fH && mH.env)this.__dv = mH.env;
        this.__dJ = mH.web_site;
        this.__dK = mH.web_cms_manager_site;
        if(this.__cU){
      ...
      setCoordinatesTransformer : function(mI){

        this.__dH = mI;
      },
      setRawServerEventsHandler : function(mJ){
      ...
      __bA : function(e){
        ...
        if(this.__dF && typeof this.__dF.error === gM){
      ...
      __dO : function(mL){
        ...
        if(mL && mL != this.__cT)return false;
        this.__cS = 0;
        this.__cT = fF;
        this.__cX = null;
        this.__db = null;
      ...
      __dP : function(mP, mO){
        ...
        if(!mP || !mO)return null;
        mP.tp = this.__da[mP.cls];
        if(typeof mP.tp == fH)return null;
        var mN;
        var mQ = this.__cR[mP.tp];
        if(typeof mQ == fH)return null;
        mN = new mQ(mP, mO);
        this.updateItem(mN, mP);
        var mM = mN && this.__dl[mN.getId()];
        if(mM){

          delete this.__dl[mN.getId()];
          mM.forEach(qx.lang.Function.bind(function(mR){

            this.updateItem(mN, mR.d);
          }, this));
        };
        return mN;
      },
      __dQ : function(mS){
        ...
        if(!mS || !this.__db)return;
        this.__db[mS.getId()] = mS;
        var mT = this.__dc[mS.getType()];
        if(typeof mT == fH){

          this.__dc[mS.getType()] = new Array;
          mT = this.__dc[mS.getType()];
        };
        mT.push(mS);
      },
      __dR : function(mU){
        ...
        if(!mU)return;
        if(typeof this.__db[mU.getId()] != fH)delete this.__db[mU.getId()];
        var mV = this.__dc[mU.getType()];
        if(typeof mV != fH)qx.lang.Array.remove(mV, mU);
        mU.dispose();
      },
      _onItemDeleted : function(mW){

        if(!mW)return;
        mW.fireEvent(fx);
        this.__dR(mW);
      },
      __dS : function(mX, mY, na){
        ...
        if(this.parseSessionData(na))mX(0); else mX(6);
      },
      __dT : function(ne, nc, nh){
        ...
        for(var i = 0;i < nh.length;i++){
          ...
          var nd = nh[i].d;
          var ng = this.__db[nb];
          if(typeof ng == fH && nf != 0 && nd){

            var ng = this.__dP(nd, nf);
            if(ng)this.__dQ(ng);
          } else {

            if(nf == 0)this.__dR(ng); else {

              if(typeof ng == fH)return;
              if(nd)this.updateItem(ng, nd);
              ng.setDataFlags(nf);
            };
          };
          nd = null;
      ...
      __dU : function(nj, ni, nm){
        ...
        var nk = {
          searchSpec : nm.searchSpec,
          dataFlags : nm.dataFlags,
          totalItemsCount : nm.totalItemsCount,
          indexFrom : nm.indexFrom,
          indexTo : nm.indexTo,
          items : []
        };
        for(var i = 0;i < nm.items.length;i++){

          var nl = this.__dP(nm.items[i], nm.dataFlags);
          if(nl)nk.items.push(nl);
          qx.core.ObjectRegistry.unregister(nl);
        };
        nj(0, nk);
        return nk;
      },
      __dV : function(nq, no, np){
        ...
        var nn = this.__dP(np.item, np.flags);
        qx.core.ObjectRegistry.unregister(nn);
        nq((nn === null ? 6 : 0), nn);
        return nn;
      },
      __dW : function(ns, nr, nt){

        if(!nt){

          var nu = this.getItem(nr);
          if(nu){
  ...
  var hP = window.setInterval(function(){

    if(qx.$$loader.scriptLoaded){

      clearInterval(hP);
      var nw = fF;
      if(document.currentScript)nw = document.currentScript.src; else {

        var ny = document.getElementsByTagName(y);
        for(var i = 0;i < ny.length;i++)if(ny[i].src.search(hg) > 0 && ny[i].src.lastIndexOf(fi) >= 0){
      ...
      var nz = gk;
      var nv = new RegExp(nz);
      var nx = nv.exec(nw);
      if(nx != null && typeof window[nx[1]] == gM)window[nx[1]]();
    };
  }, 50);
})();
(function(){
...
(function(){
  ...
  var a = "create_account",b = "function",c = "account/enable_account",d = "account/update_sub_plans",e = "account/get_account_history",f = "account/update_business_sphere",g = "update_account_min_days",h = "Object",i = "account/get_billing_plans",j = "account/update_dealer_rights",k = "account/create_account",l = "account/update_min_days",m = "switch_account",n = "update_account_history_period",o = "account/update_flags",p = "String",q = "account/do_payment",r = "wialon.item.MAccount",s = "update_account_flags",t = "number",u = "create_account_service",v = "fleetio",w = "account/delete_account",x = "update_dealer_rights",y = "update_account_service",z = "account/update_plan",A = "update_account_plan",B = "account/update_history_period",C = "delete_account_service",D = "account/get_account_data",E = "update_account_subplans",F = "sph",G = "account/update_billing_plan",H = "account/update_billing_service",I = "object";
  qx.Mixin.define(r, {
    construct : function(){

      var J = wialon.core.Session.getInstance();
      J.registerProperty(F, qx.lang.Function.bind(function(K, L){

        K.setBusinessSphere(L);
      }, this));
    },
    properties : {
      businessSphere : {
    ...
    members : {
      ...
      getAccountHistory : function(Q, P, O){
      ...
      updateDealerRights : function(S, R){
      ...
      updateFlags : function(W, V){

        var X = {
        };
        if(W && typeof W == I)X = W; else if(typeof W == t)X.flags = W;;
        return wialon.core.Remote.getInstance().remoteCall(o, {
          itemId : this.getId(),
          flags : X.flags,
          blockBalance : X.blockBalance,
          denyBalance : X.denyBalance
        }, wialon.util.Helper.wrapCallback(V));
      },
      updateMinDays : function(ba, Y){
      ...
      updateHistoryPeriod : function(bc, bb){
      ...
      updateBillingService : function(name, be, bg, bf, bd){
      ...
      doPayment : function(bm, bn, bo, bl){
      ...
      deleteAccount : function(br){

        return wialon.core.Remote.getInstance().remoteCall(w, {
          itemId : this.getId()
        }, wialon.util.Helper.wrapCallback(br));
      },
      getBillingPlans : function(bs){

        return wialon.core.Remote.getInstance().remoteCall(i, {
        }, wialon.util.Helper.wrapCallback(bs));
      },
      updateBillingPlan : function(bt, bu, bv){
      ...
      updateBusinessSphere : function(bw, bx){
    ...
    statics : {
      registerAccountProperties : function(){
        ...
        by.registerProperty(F, this.remoteUpdateBusinessSphere);
        by.registerProperty(v, this.remoteFleetio);
      },
      remoteUpdateBusinessSphere : function(bz, bA){

        bz.setBusinessSphere(bA);
      },
      remoteFleetio : function(bB, bC){
      ...
      logMessageAction : {
        accountCreated : a,
        accountSwitched : m,
        accountUpdateDealerRights : x,
        accountUpdateFlags : s,
        accountUpdateMinDays : g,
        accountUpdatedHistoryPeriod : n,
        accountUpdatePlan : A,
        accountUpdateSubplans : E,
        accountCreatedService : u,
        accountUpdatedService : y,
        accountDeletedService : C
      }
    }
  });
})();
