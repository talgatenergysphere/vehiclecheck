...
function IconBriefcaseTimer($width = "33px", $height = "33px")
{
    ?>
    <svg width="<?= $width ?>" height="<?= $height ?>" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M12.25 12.95V13.88C12.25 14.23 12.07 14.56 11.76 14.74L11 15.2" stroke="currentColor" stroke-width="1.5"
        ...
        <path d="M8 6V5.2C8 3.43 8 2 11.2 2H12.8C16 2 16 3.43 16 5.2V6" stroke="currentColor" stroke-width="1.5"
            stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M21.65 11C19.92 12.26 18 13.14 16.01 13.64" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10"
            stroke-linecap="round" stroke-linejoin="round" />
        <path d="M2.62 11.27C4.29 12.41 6.11 13.22 8 13.68" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10"
            stroke-linecap="round" stroke-linejoin="round" />
    </svg>
    <?php
}
